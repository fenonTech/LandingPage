    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
        <div className="flex flex-col items-center justify-start text-center pt-4 sm:pt-16 pb-16 sm:pb-20">
          ...
          {/* Main heading */}
          <h1
            className={`text-[1.75rem] leading-tight sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 max-w-4xl transition-all duration-1000 delay-100 px-4 ${
              isVisible
                ? "animate-fade-in-up"
