    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-0">
        <div className="flex flex-col items-center justify-start py-12 sm:py-16">
          ...
          <div className="bg-yellow-400 text-black px-4 py-2 rounded-full font-bold text-sm mb-6 sm:mb-8">
            Dashboard Completo
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 items-start w-full">
            ...
            <div className="lg:col-span-1 text-center lg:text-left flex flex-col justify-center h-full">
              {/* Heading */}
